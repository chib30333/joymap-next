    ...
    <div className="anim-fade">
      {list.length === 0 ? (
        <div className="text-center py-[70px] px-5 text-ink-3">
          <div className="w-16 h-16 rounded-[99px] bg-[var(--m-energy-soft)] grid place-items-center mt-0 mx-auto mb-4 text-[var(--m-energy)]"><Icons.heart size={28} /></div>
          <h3 className="text-[19px] text-ink">No favorites yet</h3>
          <p className="max-w-[340px] mt-2 mx-auto mb-0">Tap the heart on any experience to save it here for later.</p>
        </div>
      ) : (
