    ...
    <div className="animate-anim-fade-app">
      {list.length === 0 ? (
        <div className="text-center py-16 px-5 text-ink-3">
          <div className="w-16 h-16 rounded-pill bg-[var(--m-energy-soft)] grid place-items-center mt-0 mx-auto mb-4 text-[var(--m-energy)]">
            <Icons.heart size={28} />
          </div>
          <h3 className="text-xl text-ink">{t("No favorites yet")}</h3>
